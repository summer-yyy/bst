<template>
  <div class="index">
    ...
    <div class="card-show usual-address">
      <itemWrapper :title="title1" :icon="icon1" @iconClick="$router.push({path:'/address',query: usualAddresses})">
   ...
   <div class="card-show history-search" v-show="historySearch.length> 0">
     <History @clear="historySearch = []">
...
export default {
  ...
  mounted() {
    console.log(this.historySearch.length);
  }
};
</script>
